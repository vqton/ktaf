"""Accounting period (Kỳ kế toán) models.

Provides KyKeToan model for managing accounting periods.

Status (trang_thai): mo (open), khoa (locked)
"""
...
class KyKeToan(Base):
    """Accounting period (Kỳ kế toán) model.

    Represents a month-long accounting period with date range and lock status.
    """
